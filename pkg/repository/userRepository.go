...
func (repo *UsersSegmentsRepository) ManageUserToSegments(slugsToAdd []string, slugsToRemove []string, userId uint) (*entity.ManageUserToSegmentsResponse, error) {
	...
	return &entity.ManageUserToSegmentsResponse{
